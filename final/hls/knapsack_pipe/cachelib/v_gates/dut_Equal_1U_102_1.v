...
// Generated on: Jun  4 2025 00:52:00 CST (Jun  3 2025 16:52:00 UTC)

module dut_Equal_1U_102_1(in1, out1);
  input [6:0] in1;
  output out1;
  wire [6:0] in1;
  wire out1;
  ...
  NOR2X2 g43(.A (in1[0]), .B (n_0), .Y (n_2));
  CLKINVX12 g44(.A (in1[2]), .Y (n_1));
  CLKINVX20 g45(.A (in1[1]), .Y (n_0));
endmodule
