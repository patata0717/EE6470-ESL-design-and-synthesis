...
define_hls_config $design PIPELINE2 -DPIPE_OPTION=SOFT_STALL -DII=2 -post_elab_tcl {
    map_to_reg_bank [find -array "items_V"]
    map_to_reg_bank [find -array "items_W"]
    constrain_latency [find -loop "while_1"]
}

define_hls_config $design PIPELINE4 -DPIPE_OPTION=SOFT_STALL -DII=4 -post_elab_tcl {
    map_to_reg_bank [find -array "items_V"]
    map_to_reg_bank [find -array "items_W"]
    constrain_latency [find -loop "while_1"]
}
