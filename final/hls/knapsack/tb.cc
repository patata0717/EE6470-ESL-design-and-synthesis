...
void tb::source()
{
    ...
    for (int i = 0; i < NUM_ITEMS; ++i) {
        ...
        V.push_back(pkt.range(47, 40));
        W.push_back(pkt.range(55, 48));
    }
    close_stimulus_file();
...
{
    const char * name = ( _name == NULL ? "stimulus_100.dat" : _name );
...
input_t tb::read_stimulus_value()
{
    ...
    input_t value = 0;
    value.range(55, 48) = (sc_uint<8>)weight;
    value.range(47, 40) = (sc_uint<8>)val;
