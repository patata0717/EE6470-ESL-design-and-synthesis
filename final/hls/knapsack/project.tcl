...
define_hls_config	$design MEM_UNROLL_ALL -post_elab_tcl {
    map_to_memory -mem_type "RAM_8X8_1RW" [find -array "items_V"]
    map_to_memory -mem_type "RAM_8X8_1RW" [find -array "items_W"]
    constrain_latency [find -loop "while_1"]
...
define_hls_config	$design	MEM_FLAT_UNROLL_ALL --flatten_arrays=all -post_elab_tcl {
    map_to_memory -mem_type "RAM_8X8_1RW" [find -array "items_V"]
    map_to_memory -mem_type "RAM_8X8_1RW" [find -array "items_W"]
    unroll_loops [find -loop "*_loop" ]
    constrain_latency [find -loop "while_1"]
...
define_hls_config	$design	MEM_FLAT_UNROLL_ALL_FAST --flatten_arrays=all -post_elab_tcl {
    map_to_memory -mem_type "RAM_8X8_1RW" [find -array "items_V"]
    map_to_memory -mem_type "RAM_8X8_1RW" [find -array "items_W"]
    unroll_loops [find -loop "*_loop" ]
...
define_hls_config $design PIPELINE1 -DPIPE_OPTION=SOFT_STALL -DII=1
define_hls_config $design PIPELINE2 -DPIPE_OPTION=SOFT_STALL -DII=2
define_hls_config $design PIPELINE3 -DPIPE_OPTION=SOFT_STALL -DII=3
define_hls_config $design PIPELINE4 -DPIPE_OPTION=SOFT_STALL -DII=4
define_hls_config $design DPA --dpopt_auto=op,expr
...
define_hls_config $design BUF_UNROLL_ALL -post_elab_tcl {
    unroll_loops [find -loop "*_loop" ]
    constrain_latency [find -loop "while_1"]
}

define_hls_config	$design	BUF_FLAT_UNROLL_ALL --flatten_arrays=all -post_elab_tcl {
    unroll_loops [find -loop "*_loop" ]
    constrain_latency [find -loop "while_1"]
}

define_hls_config	$design	BUF_FLAT_UNROLL_ALL_FAST --flatten_arrays=all -post_elab_tcl {
    unroll_loops [find -loop "*_loop" ]
    constrain_latency -max_lat $HLS::ACHIEVABLE [find -loop "while_1"]
}
...
define_hls_config	$design	REG_UNROLL_ALL -post_elab_tcl {
    map_to_reg_bank [find -array "items_V"]
    map_to_reg_bank [find -array "items_W"]
    constrain_latency [find -loop "while_1"]
    unroll_loops [find -loop "*_loop" ]
...
define_hls_config	$design	REG_FLAT_UNROLL_ALL --flatten_arrays=all -post_elab_tcl {
    map_to_reg_bank [find -array "items_V"]
    map_to_reg_bank [find -array "items_W"]
    unroll_loops [find -loop "*_loop" ]
    constrain_latency [find -loop "while_1"]
...
define_hls_config	$design	REG_FLAT_UNROLL_ALL_FAST --flatten_arrays=all -post_elab_tcl {
    map_to_reg_bank [find -array "items_V"]
    map_to_reg_bank [find -array "items_W"]
    unroll_loops [find -loop "*_loop" ]
    constrain_latency -max_lat $HLS::ACHIEVABLE [find -loop "while_1"]
