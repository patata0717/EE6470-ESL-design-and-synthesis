...
public:
	...
	//Add
	addr_t log_filter_start_addr = 0x73000000;
 	addr_t log_filter_size = 0x01000000;
 	addr_t log_filter_end_addr = log_filter_start_addr + log_filter_size - 1;
...
int sc_main(int argc, char **argv) {
	...
	// address mapping
	{
		...
		//Add
		bus.ports[it++] = new PortMapping(opt.log_filter_start_addr, opt.log_filter_end_addr);
...

	{
		...
		//Add
		bus.isocks[it++].bind(log_filter.t_skt);
	}
