...
define_hls_config LaplacianFilter BASIC
...
define_sim_config V_GF_BASIC "GaussianFilter RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
define_sim_config V_LF_BASIC "LaplacianFilter RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
...
define_sim_config V_GF_DPA   "GaussianFilter RTL_V DPA"   -argv "$IN_FILE_NAME $OUT_FILE_NAME"
define_sim_config V_LF_DPA   "LaplacianFilter RTL_V DPA"   -argv "$IN_FILE_NAME $OUT_FILE_NAME"
